            ...
            <div style={{ width: "100%", height: "100vh", display: "flex" }}>
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        ...
                        >
                          <p>
                            ...
                            <Chip icon={<StarIcon color="error" />} label={<p style={{color: 'white', fontSize: '20px'}}>0</p>} />
                            <p style={{color: 'green', fontWeight: 'bold'}}>Nota Média do Mês</p>
                          </p>
                        </div>
                      </div>
                      <div
                      ...
                      >
                        ...
                        >
                          <p>
                            <Chip icon={<PercentIcon color="success" />} label={<p style={{color: 'white', fontSize: '20px'}}>100</p>} />
                            <p style={{color: 'green', fontWeight: 'bold'}}>Finalizadas no Prazo</p>
                          </p>
                        </div>
                      </div>
                      ...
                      >
                        ...
                        >
                          <p>
                            <Chip icon={<CallReceivedIcon />} label={<p style={{color: 'white', fontSize: '20px'}}>4</p>} />
                            <p style={{color: 'green', fontWeight: 'bold'}}>Solicitações Recebidas</p>
                            <Chip icon={<PresentToAllIcon />} label={<p style={{color: 'white', fontSize: '20px'}}>1</p>} />
                            <p style={{color: 'green', fontWeight: 'bold'}}>Solicitações Finalizadas</p>
                          </p>
                        </div>
                      </div>
                      ...
                      >
                        ...
                        >
                          <p>
                            <Chip icon={<CallReceivedIcon />} label={<p style={{color: 'white'}}>25% / Assunto Mais Procurado</p>} />
                            <p style={{color: 'green', fontWeight: 'bold'}}>EDUCACIONAL / CURSOS</p>
                            <Chip icon={<PresentToAllIcon />} label={<p style={{color: 'white'}}>100% / Setor mais Recorrente</p>} />
                            <p style={{color: 'green', fontWeight: 'bold'}}>DESENVOLVIMENTO</p>
                          </p>
                        </div>
                      </div>
                    </div>
                  ...
                  >
                    <div style={{width: '100%', textAlign: 'center', height: 'fit-content', marginBottom: '20px'}}>
                      <h2>Indicadores do Setor</h2>
                    </div>
                    <div style={{width: '100%', display: 'flex', justifyContent: 'space-between'}}>
                      <div style={{width: '49%', height: '200px', backgroundColor: 'white',  borderRadius: '20px', display: 'flex', justifyContent: 'center'}}>
                      <div
                          style={{
                            width: "170px",
                            marginTop: "30px",
                        ...
                        >
                          <p>
                            <Rating name="no-value" value={null} />
                            <Chip icon={<StarIcon color="error" />} label={<p style={{color: 'white', fontSize: '20px'}}>0</p>} />
                            <p style={{color: 'red', fontWeight: 'bold'}}>Nota Média do Mês</p>
                          </p>
                        </div>
                      </div>
                      <div style={{width: '49%', height: '200px', backgroundColor: 'white',  borderRadius: '20px', display: 'flex', justifyContent: 'center'}}>
                      <div
                        ...
                        >
                          <p>
                            <Chip icon={<PercentIcon color="success" />} label={<p style={{color: 'green', fontSize: '30px'}}>74</p>} />
                            <p style={{color: 'green', fontWeight: 'bold'}}>Finalizadas no Prazo</p>
                          </p>
                        </div>
                      </div>
